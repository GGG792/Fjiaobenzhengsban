...
local itemDatabase = {
    ["Poor Soldier Camp"] = "Military", ["Soldier Camp"] = "Military", ["Militia Camp"] = "Military",
    ["Watchtower"] = "Military", ["Castle Warriors"] = "Military", ["Giant Cave"] = "Military",
    ["Tent"] = "Houses", ["Workshop"] = "Houses", ["Small House"] = "Houses", ["Windmill"] = "Houses",
    ["Blacksmith"] = "Houses", ["Tavern"] = "Houses", ["Large House"] = "Houses", ["Mansion"] = "Houses",
    ["Castle With Housing"] = "Houses",
    ["Wheat Farm"] = "Farms", ["Bush Farm"] = "Farms", ["Carrot Farm"] = "Farms", ["Tomato Farm"] = "Farms",
    ["Apple Farm"] = "Farms", ["Tree Farm"] = "Farms", ["Sheep Farm"] = "Farms", ["Flower Farm"] = "Farms",
    ["Copper Mine"] = "Farms", ["Silver Mine"] = "Farms", ["Gold Mine"] = "Farms", ["Diamond Mine"] = "Farms",
    ["Bakery"] = "Farms", ["Bank"] = "Farms", ["Smithy"] = "Farms", ["Market"] = "Farms", ["Fishing Pond"] = "Farms"
}

local nameTranslation = {
    ["贫穷士兵营地 (Poor Soldier Camp)"] = "Poor Soldier Camp",
    ["士兵营地 (Soldier Camp)"] = "Soldier Camp",
    ["民兵营地 (Militia Camp)"] = "Militia Camp",
    ["了望塔 (Watchtower)"] = "Watchtower",
    ["城堡战士 (Castle Warriors)"] = "Castle Warriors",
    ["巨型洞穴 (Giant Cave)"] = "Giant Cave",
    ["帐篷 (Tent)"] = "Tent",
    ["车间 (Workshop)"] = "Workshop",
    ["小房子 (Small House)"] = "Small House",
    ["风车 (Windmill)"] = "Windmill",
    ["铁匠铺 (Blacksmith)"] = "Blacksmith",
    ["酒馆 (Tavern)"] = "Tavern",
    ["大房子 (Large House)"] = "Large House",
    ["豪宅 (Mansion)"] = "Mansion",
    ["带房子的城堡 (Castle With Housing)"] = "Castle With Housing",
    
    -- 农场类
    ["小麦农场 (Wheat Farm)"] = "Wheat Farm",
    ["灌木农场 (Bush Farm)"] = "Bush Farm",
    ["胡萝卜农场 (Carrot Farm)"] = "Carrot Farm",
    ["番茄农场 (Tomato Farm)"] = "Tomato Farm",
    ["苹果农场 (Apple Farm)"] = "Apple Farm",
    ["树木农场 (Tree Farm)"] = "Tree Farm",
    ["绵羊农场 (Sheep Farm)"] = "Sheep Farm",
    ["花卉农场 (Flower Farm)"] = "Flower Farm",
    ["铜矿 (Copper Mine)"] = "Copper Mine",
    ["银矿 (Silver Mine)"] = "Silver Mine",
    ["金矿 (Gold Mine)"] = "Gold Mine",
    ["钻石矿 (Diamond Mine)"] = "Diamond Mine",
    ["面包店 (Bakery)"] = "Bakery",
    ["银行 (Bank)"] = "Bank",
    ["锻造厂 (Smithy)"] = "Smithy",
    ["市场 (Market)"] = "Market",
    ["鱼塘 (Fishing Pond)"] = "Fishing Pond"
}
...
CombatTab:Dropdown({
    Title = "选择要购买的物品",
    Values = dropDownOptionsCN,
    Value = "小麦农场 (Wheat Farm)",
    Callback = function(selectedCN)
...
CombatTab:Toggle({
    Title = "防挂机",
    Desc = "屏蔽Roblox的超20分钟挂机踢出系统",
    Value = true,
    Callback = function(state) 
        getgenv().AntiAfkEnabled = state
        WindUI:Notify({
            Title = "Aero",
            Content = state and "防挂机已开启" or "防挂机已关闭",
