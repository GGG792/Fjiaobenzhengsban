...
do
    ...
    local function createBeam(startPos, endPos)
        ...
        part1.Anchored = true; part1.CanCollide = false; part1.Transparency = 1; part1.Size = Vector3.new(0.1,0.1,0.1)
        part1.Position = startPos; part1.Parent = Workspace
        local part2 = Instance.new("Part")
        part2.Anchored = true; part2.CanCollide = false; part2.Transparency = 1; part2.Size = Vector3.new(0.1,0.1,0.1)
        part2.Position = endPos; part2.Parent = Workspace
        
        local attachment1 = Instance.new("Attachment", part1)
        local attachment2 = Instance.new("Attachment", part2)
        
        local beam1 = Instance.new("Beam", part1)
        beam1.Attachment0 = attachment1; beam1.Attachment1 = attachment2
        beam1.Width0 = 0.25; beam1.Width1 = 0.25; beam1.Texture = "rbxassetid://7136858729"
        ...
        Callback = function(state)
            if state then
                connection = RunService.Heartbeat:Connect(function()
                    if os.clock() - last_attack < cooldown then return end
    ...
    KillTab:Input({
        Title = "射击间隔(秒)",
        Default = "1.5",
        Callback = function(value) cooldown = tonumber(value) or 1.5 end
    })

    KillTab:Toggle({
        Title = "命中日志",
        Value = false,
        Callback = function(state) HitLogEnabled = state end
    })
end